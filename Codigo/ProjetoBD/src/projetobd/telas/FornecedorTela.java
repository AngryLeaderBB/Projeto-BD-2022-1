...
public class FornecedorTela extends javax.swing.JFrame {
    ...
    private void update(){
        ...
        DefaultTableModel modelo = new DefaultTableModel(new Object[] {"CNPJ", "Telefone",
        "Nome"},0);
        
        for (int i = 0; i < listaFornecedor.size(); i++){
            Fornecedor modeloAux = listaFornecedor.get(i);
            Object linha[] = new Object[] {modeloAux.getCnpj(), 
                modeloAux.getTelefone(), modeloAux.getNomeEmpresa()};
    ...
    private void jTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable2MouseClicked
        String id = valueOf(listaFornecedor.get(jTable2.getSelectedRow()).getCnpj());
